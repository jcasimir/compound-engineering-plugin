...
```bash
/workflow:5-compound                    # Document the most recent fix
/workflow:5-compound [brief context]    # Provide additional context hint
```
...
<manual_override> Use /workflow:5-compound [context] to document immediately without waiting for auto-detection. </manual_override> </auto_invoke>
...
- **Manual trigger**: User can invoke agents after /workflow:5-compound completes for deeper review

## Related Commands

- `/research [topic]` - Deep investigation (searches docs/solutions/ for patterns)
- `/workflow:1-plan` - Planning workflow (references documented solutions)
